  ...
  return (
    <nav className={styles.dock}>
      <div className={styles.dockIcons}>
        ...
        <a href="#about" className={styles.dockItem}>
          <FaUser size={28} />
          <span>About</span>
        </a>
        <a href="#skills" className={styles.dockItem}>
          <FaCode size={28} />
          <span>Skills</span>
        </a>
        <a href="#projects" className={styles.dockItem}>
          <FaBriefcase size={28} />
          <span>Projects</span>
        </a>
        <a href="#experience" className={styles.dockItem}>
          <FaLaptop size={28} />
          <span>Experience</span>
        </a>
        <a href="#contact" className={styles.dockItem}>
          <FaEnvelope size={28} />
          <span>Contact</span>
        </a>
      </div>
